...
const CareflexBackground = () => {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      ...
      { rotation: 2, repeat: -1, yoyo: true, ease: 'power3.inOut', duration: 3 }
    )
  }, [])

  useEffect(() => {
    const smallBubbleArr = [beakerBubble1.current, beakerBubble2.current, beakerBubble3.current]

    gsap.set(smallBubbleArr, { opacity: 0 })
  }, [])

  useEffect(() => {
    const bigBubbleArr = [topBubble2.current, topBubble1.current, topBubble3.current]
    const smallBubbleArr = [beakerBubble1.current, beakerBubble2.current, beakerBubble3.current]
    function bubbles() {
  ...
  return (
    <svg
      ...
      <g id="Ebene_2" data-name="Ebene 2">
        ...
        <g>
          {/* atoms */}
          <circle className="cls-4" cx="1053.7" cy="54.9" r="19.5" />
          <circle className="cls-4" cx="1189.2" cy="82.9" r="23.1" />
          <circle className="cls-4" cx="1061.5" cy="221.7" r="27.6" />
          <rect
            className="cls-4"
            x="1146.92"
            y="62.74"
        ...
        <g>
          ...
          <g>
            <path
              ...
              transform="translate(-69.8 -15.7)"
            />
            <path className="cls-2" d="M69.8,126a36.2,36.2,0,0,1,72.4,0Z" transform="translate(-69.8 -15.7)" />
            <g>
              <image
                className="cls-6"
                width="251"
          ...
          <rect className="cls-2" x="96" y="254.9" width="165.1" height="10.8" />
          <rect className="cls-2" x="96" y="227.2" width="165.1" height="10.8" />
          <rect className="cls-2" x="96" y="199.5" width="165.1" height="10.8" />
          <rect className="cls-2" x="96" y="171.7" width="165.1" height="10.8" />
          <rect className="cls-2" x="96" y="144" width="165.1" height="10.8" />
          <g>
            <path
              className="cls-7"
              ...
              transform="translate(-69.8 -15.7)"
            />
            <path className="cls-2" d="M156.8,162.7a36.2,36.2,0,0,1,72.4,0Z" transform="translate(-69.8 -15.7)" />
            <g>
              <image
                className="cls-6"
                width="251"
          ...
          <rect className="cls-2" x="183.1" y="291.7" width="165.1" height="10.8" />
          <rect className="cls-2" x="183.1" y="264" width="165.1" height="10.8" />
          <rect className="cls-2" x="183.1" y="236.2" width="165.1" height="10.8" />
          <rect className="cls-2" x="183.1" y="208.5" width="165.1" height="10.8" />
          <rect className="cls-2" x="183.1" y="180.7" width="165.1" height="10.8" />
        </g>
        <g>
          <g>
            {/* hands and family */}
          ...
          <g>
            <path
              ...
              transform="translate(-69.8 -15.7)"
            />
            <circle className="cls-2" cx="1494.6" cy="470.4" r="21.5" />
            <path
              className="cls-2"
              ...
              transform="translate(-69.8 -15.7)"
            />
            <circle className="cls-2" cx="1557.1" cy="470.4" r="21.5" />
            <path
              className="cls-2"
              ...
              transform="translate(-69.8 -15.7)"
            />
            <circle className="cls-2" cx="1608.7" cy="548.6" r="9.7" />
            <path
              className="cls-2"
              ...
              transform="translate(-69.8 -15.7)"
            />
            <circle className="cls-2" cx="1441.9" cy="548.6" r="9.7" />
          </g>
        </g>
        <g
          id="beaker_bubbles"
          ...
          <g>
            <path
              ...
              transform="translate(-69.8 -15.7)"
            />
            <circle ref={topBubble3} className="cls-2" cx="1471.4" cy="17.5" r="17.5" />
            <path
              ref={topBubble1}
              id="bubble"
              className="cls-2"
        ...
        <g>
          <g>
            <path
              ...
              transform="translate(-69.8 -15.7)"
            />
            <rect className="cls-4" x="769.4" y="1133" width="25.1" height="25.1" />
          </g>
          <g>
            <path
              className="cls-7"
              ...
              transform="translate(-69.8 -15.7)"
            />
            <rect className="cls-7" x="849.5" y="1133" width="25.1" height="25.1" />
          </g>
          <g>
            <path
              className="cls-4"
              ...
              transform="translate(-69.8 -15.7)"
            />
            <rect className="cls-4" x="929.7" y="1133" width="25.1" height="25.1" />
          </g>
        ...
        <g id="clipboard">
          <rect className="cls-8" x="1365.7" y="947.6" width="314.4" height="418.9" />
          <path
            className="cls-2"
          ...
          <rect className="cls-2" x="1394.9" y="1005.5" width="254.8" height="14.2" />
          <rect className="cls-2" x="1394.9" y="1056.4" width="254.8" height="14.2" />
          <rect className="cls-2" x="1480.3" y="1107.3" width="169.5" height="14.2" />
          <rect className="cls-2" x="1480.3" y="1158.2" width="169.5" height="14.2" />
          <rect className="cls-2" x="1480.3" y="1209.1" width="169.5" height="14.2" />
          <rect className="cls-2" x="1480.3" y="1260" width="169.5" height="14.2" />
          <rect className="cls-2" x="1480.3" y="1311" width="169.5" height="14.2" />
        </g>
        <g id="trianglebottle">
          <path
            className="cls-7"
        ...
        <g>
          <rect className="cls-7" x="36.5" y="676" width="145.8" height="21.8" />
          <path
            className="cls-4"
